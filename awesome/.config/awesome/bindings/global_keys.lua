...
-- Global (root) keybindings, plus the per-tag (1-9) key generation loop.
...
local globalkeys = gears.table.join(
    awful.key({modkey,            }, "a",
        ...
        { description = "toggle Hermes agent window", group = "launcher" }),
    awful.key({ modkey, "Shift"   }, "a",
        function()
            awful.spawn(terminal .. " -e " .. os.getenv("HOME") .. "/.local/bin/ai-sandbox.sh code",
    ...
    awful.key({ modkey,           }, "w", function () menu.menu:show() end,
